...
static void gldelf_i386_before_plugin_all_symbols_read
  (void);
static void gldelf_i386_after_open (void);
static void gldelf_i386_before_allocation (void);
static void gldelf_i386_after_allocation (void);
...
static void
gldelf_i386_before_plugin_all_symbols_read (void)
{
...
static void
gldelf_i386_after_allocation (void)
{
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/usr/local/cross/i386-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
...
struct ld_emulation_xfer_struct ld_elf_i386_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf_i386_before_plugin_all_symbols_read,
  gldelf_i386_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf_i386_after_allocation,
