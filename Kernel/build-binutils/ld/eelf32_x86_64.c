...
/* 32 bit ELF emulation code for elf32_x86_64
...
static void gldelf32_x86_64_before_parse (void);
static void gldelf32_x86_64_before_plugin_all_symbols_read
  (void);
static void gldelf32_x86_64_after_open (void);
static void gldelf32_x86_64_before_allocation (void);
static void gldelf32_x86_64_after_allocation (void);
...
static void
gldelf32_x86_64_before_parse (void)
{
  ldfile_set_output_arch ("i386:x64-32", bfd_arch_i386);
...
static void
gldelf32_x86_64_before_plugin_all_symbols_read (void)
{
...
static void
gldelf32_x86_64_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 32, "/usr/local/cross");
}
...
static void
gldelf32_x86_64_before_allocation (void)
{
...
static void
gldelf32_x86_64_after_allocation (void)
{
...
static char *
gldelf32_x86_64_get_script (int *isfile)
{
  *isfile = 0;
...
OUTPUT_ARCH(i386:x64-32)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/usr/local/cross/x86_64-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
...
static bool
gldelf32_x86_64_handle_option (int optc)
{
  switch (optc)
    {
    default:
...
static void
gldelf32_x86_64_list_options (FILE * file)
{
...
struct ld_emulation_xfer_struct ld_elf32_x86_64_emulation =
{
  elf_x86_64_before_parse,
  syslib_default,
  hll_default,
  ldelf_after_parse,
  gldelf32_x86_64_before_plugin_all_symbols_read,
  gldelf32_x86_64_after_open,
  after_check_relocs_default,
  ldelf_before_place_orphans,
  gldelf32_x86_64_after_allocation,
  ldelf_set_output_arch,
  ldemul_default_target,
  gldelf32_x86_64_before_allocation,
  ...
  NULL,
  gldelf32_x86_64_add_options,
  gldelf32_x86_64_handle_option,
  NULL,
  gldelf32_x86_64_list_options,
  ldelf_load_symbols,
  NULL,
  NULL,
  NULL,
