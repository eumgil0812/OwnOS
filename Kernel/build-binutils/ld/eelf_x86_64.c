...
static void gldelf_x86_64_before_plugin_all_symbols_read
  (void);
...
static void
gldelf_x86_64_before_plugin_all_symbols_read (void)
{
...
gldelf_x86_64_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 64, "/usr/local/cross");
}
...
struct ld_emulation_xfer_struct ld_elf_x86_64_emulation =
{
  ...
  hll_default,
  ldelf_after_parse,
  gldelf_x86_64_before_plugin_all_symbols_read,
